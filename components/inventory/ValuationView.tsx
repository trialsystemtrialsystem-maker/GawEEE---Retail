    ...
    <div className="space-y-4">
      <div className="flex flex-wrap items-end gap-3">
        ...
        <ExportCsvButton
          ...
          rows={items.map((i) => ({ SKU: i.sku, Produk: i.name, Kategori: i.category_name ?? '', Stok: i.quantity_on_hand, 'Nilai (HPP)': i.cost_value, 'Nilai Jual': i.retail_value, ABC: i.abc_class, Pergerakan: i.health }))}
        />
      </div>
