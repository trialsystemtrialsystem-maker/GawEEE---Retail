...
import { MASTER_DATA_SECTIONS } from '@/lib/nav/adminHub'
  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-gray-500">Semua data referensi yang bisa Anda tambah, ubah, atau hapus — dari satu tempat.</p>
      </div>
