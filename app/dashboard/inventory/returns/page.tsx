...
import { PurchaseReturnManager } from '@/components/suppliers/PurchaseReturnManager'
...
export default async function PurchaseReturnPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {profile?.outlet_id ? (
        <PurchaseReturnManager outletId={profile.outlet_id} canManage={['outlet_manager', 'master_admin'].includes(profile.role)} />
      ) : (
